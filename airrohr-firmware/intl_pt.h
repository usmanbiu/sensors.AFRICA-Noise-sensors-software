...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM anexado";
const char INTL_GSM_PIN[] PROGMEM = "PIN GSM";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "NOME DE USUÁRIO GPRS";
const char INTL_GPRS_PASSWORD[] PROGMEM = "SENHA GPRS";
