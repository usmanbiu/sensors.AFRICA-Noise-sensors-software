...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM aangesloten ";
const char INTL_GSM_PIN[] PROGMEM = "GSM PIN";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "GPRS-GEBRUIKERSNAAM";
const char INTL_GPRS_PASSWORD[] PROGMEM = "GPRS-WACHTWOORD";
