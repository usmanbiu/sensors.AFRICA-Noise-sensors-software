...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM vedhæftet";
const char INTL_GSM_PIN[] PROGMEM = "GSM PIN";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "GPRS BRUGERNAVN";
const char INTL_GPRS_PASSWORD[] PROGMEM = "GPRS ADGANGSKODE";
