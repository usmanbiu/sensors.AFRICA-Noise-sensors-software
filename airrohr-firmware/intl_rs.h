...
const char INTL_GSM_CAPABLE[] PROGMEM = "ГСМ у прилогу";
const char INTL_GSM_PIN[] PROGMEM = "ГСМ ПИН";
const char INTL_GPRS_APN[] PROGMEM = "ГПРС АПН";
const char INTL_GPRS_USERNAME[] PROGMEM = "ГПРС УСЕРНАМЕ";
const char INTL_GPRS_PASSWORD[] PROGMEM = "ГПРС ПАССВОРД";
