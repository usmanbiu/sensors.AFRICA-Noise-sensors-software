...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM connecté";
const char INTL_GSM_PIN[] PROGMEM = "GSM PIN";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "NOM D'UTILISATEUR GPRS";
const char INTL_GPRS_PASSWORD[] PROGMEM = "Mot de passe GPRS";
