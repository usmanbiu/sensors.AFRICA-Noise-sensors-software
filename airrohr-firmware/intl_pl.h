...
const char INTL_GSM_CAPABLE[] PROGMEM = "Dołączono GSM";
const char INTL_GSM_PIN[] PROGMEM = "PIN GSM";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "NAZWA UŻYTKOWNIKA GPRS";
const char INTL_GPRS_PASSWORD[] PROGMEM = "HASŁO GPRS";
