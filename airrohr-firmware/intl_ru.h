...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM подключен";
const char INTL_GSM_PIN[] PROGMEM = "GSM-пин";
const char INTL_GPRS_APN[] PROGMEM = "GPRS-APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "GPRS-ИМЯ ПОЛЬЗОВАТЕЛЯ";
const char INTL_GPRS_PASSWORD[] PROGMEM = "GPRS-ПАРОЛЬ";
