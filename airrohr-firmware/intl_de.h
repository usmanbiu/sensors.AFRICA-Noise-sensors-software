...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM angeschlossen";
const char INTL_GSM_PIN[] PROGMEM = "GSM PIN";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "GPRS-BENUTZERNAME";
const char INTL_GPRS_PASSWORD[] PROGMEM = "GPRS-PASSWORT";
