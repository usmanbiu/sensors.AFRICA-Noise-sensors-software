...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM adjunto";
const char INTL_GSM_PIN[] PROGMEM = "GSM PIN";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "NOMBRE DE USUARIO GPRS";
const char INTL_GPRS_PASSWORD[] PROGMEM = "CONTRASEÑA GPRS";
