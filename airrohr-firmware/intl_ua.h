...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM підключений";
const char INTL_GSM_PIN[] PROGMEM = "Штифт GSM";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "Ім'я користувача GPRS";
const char INTL_GPRS_PASSWORD[] PROGMEM = "ПАРОЛЬ GPRS";
