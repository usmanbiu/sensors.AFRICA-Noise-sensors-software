...
const char INTL_GSM_CAPABLE[] PROGMEM = "GSM ПРИКАЧЕН";
const char INTL_GSM_PIN[] PROGMEM = "GPRS ПИН";
const char INTL_GPRS_APN[] PROGMEM = "GPRS APN";
const char INTL_GPRS_USERNAME[] PROGMEM = "GPRS потребителско име";
const char INTL_GPRS_PASSWORD[] PROGMEM = "GPRS парола";
